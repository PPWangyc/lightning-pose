...
from lightning_pose.data.utils import evaluate_heatmaps_at_location, undo_affine_transform_batch
...
class HeatmapTracker(BaseSupervisedTracker):
    ...
    def make_upsampling_layers(self) -> torch.nn.Sequential:
        ...
        if self.backbone_arch in ["vit_h_sam", "vit_b_sam", "vit_cm", "vit_m"]:
            n_layers_to_build = -1
